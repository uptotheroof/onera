...
{
    onera.push ( Onus::new (    "Task name"                 .to_string(),
                                "--/--/----"                .to_string(),
                                true                                    ,
                                true                                    ,
                                true                                    ,
    ...
    onera[0].seq.push ( Sequence::new ( "my seq"    .to_string(),
                                        "-"         .to_string(),
                                        "00:00:00"  .to_string(),
                                        "00:00:00"  .to_string(),
                                        "00:00:00"  .to_string() )  );
    ...
    onera[0].int.push ( Interupts::new (    "my int"    .to_string(),
                                            "*"         .to_string(),
                                            "00:00:00"  .to_string(),
                                            "00:00:00"  .to_string(),
                                            "00:00:00"  .to_string() )  );
                                    
    onera.push ( Onus::new (    "Second task name"          .to_string(),
                                "--/--/----"                .to_string(),
                                true                                    ,
                                true                                    ,
                                true                                    ,
    ...
    onera[1].seq.push ( Sequence::new ( "my seq second" .to_string(),
                                        "-"             .to_string(),
                                        "00:00:00"      .to_string(),
                                        "00:00:00"      .to_string(),
                                        "00:00:00"      .to_string() )  );
    ...
    onera[1].int.push ( Interupts::new (    "my int second" .to_string(),
                                            "*"             .to_string(),
                                            "00:00:00"      .to_string(),
                                            "00:00:00"      .to_string(),
                                            "00:00:00"      .to_string() )  );
 
    onera[0].seq.push ( Sequence::new ( "anothersecond" .to_string(),
                                        "-"             .to_string(),
                                        "00:00:00"      .to_string(),
                                        "00:00:00"      .to_string(),
                                        "00:00:00"      .to_string() )  );
    ...
    onera[0].int.push ( Interupts::new (    "another int"   .to_string(),
                                            "-"             .to_string(),
                                            "00:00:00"      .to_string(),
                                            "00:00:00"      .to_string(),
                                            "00:00:00"      .to_string() )  );
